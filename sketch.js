var striker,strikerImg,computer,goal1,goal2,center,edge1,edge2,edge3,edge4,gameOver,restart,scoreCard,scoreCard1;
var playerscore=0;
var compscore=0;
 ...
 function preload(){
  ...
  scorecardImg=loadImage("scoreCard.png");
  scoreCard1Img=loadImage("scoreCardinverse.png");
 }
function setup(){
  createCanvas(800,600);
  
  edges = createEdgeSprites();
  scoreCard= createSprite(700,500,20,100);
  scoreCard.scale=0.3;
  scoreCard1= createSprite(700,100,20,100);
  scoreCard1.scale=0.3;
...
function draw(){
  background("blue");
   ...
   textSize(18);
   text(compscore,700,120);
   text(playerscore,700,480);
   textFont("georgia")
   textSize(21);
   text ("SCORECARD",630,300);
...
scoreCard.addImage(scorecardImg);
scoreCard1.addImage(scoreCard1Img);
